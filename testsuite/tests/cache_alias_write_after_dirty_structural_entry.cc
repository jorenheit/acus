// Dirty a structural dynamic field, then overwrite it through a pointer; the alias write must win.
// Expected: "X"
...
c.function("main").begin(); {
  ...
  c.assign(c.structField(c.arrayElement("arr", "i"), "x"), literal::u8('D'));
